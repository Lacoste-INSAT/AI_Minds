...
from reasoning.cpumodel.fusion import (
    fuse_results,
    format_context_for_llm,
    _compute_rrf_score,
    _compute_recency_factor,
)
from reasoning.cpumodel.models import ChunkEvidence, RetrievalResult
...
class TestFormatContextForLLM:
    ...
    def test_empty_context(self):
        ...
        from reasoning.cpumodel.models import FusedContext
