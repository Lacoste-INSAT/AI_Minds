...
class TestFullPipelineWithMocks:
    ...
    async def test_simple_query_pipeline(self):
        ...
        with patch("reasoning.reasoning.cpumodel.llm_agent.generate_completion") as mock_llm:
            ...
            from reasoning.reasoning.cpumodel.models import LLMResponse
    ...
    async def test_multi_hop_query_uses_graph(self):
        ...
        from reasoning.reasoning.cpumodel.query_planner import classify_query
...
class TestPipelineEdgeCases:
    ...
    def test_fusion_handles_all_empty(self):
        ...
        from reasoning.reasoning.cpumodel.fusion import fuse_results
...
class TestContractCompliance:
    ...
    def test_default_model_is_t3(self):
        ...
        from reasoning.reasoning.cpumodel.ollama_client import DEFAULT_TIER
        from reasoning.reasoning.cpumodel.models import ModelTier
