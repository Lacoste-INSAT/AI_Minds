...
from backend.routers.openai_compat import router as openai_router
...
app.include_router(openai_router)  # OpenAI-compatible API for rowboat integration
app.include_router(runs_router)  # Chat runs/sessions for frontend
