"""
Quick Windows test - Create files in a test folder and watch them get detected.
Run from the ingestion/observer directory.
"""
...
def main():
    ...
    print("\n" + "=" * 70)
    print("  Synapsis Observer - Windows Test")
    print("=" * 70)
